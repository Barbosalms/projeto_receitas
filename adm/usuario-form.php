            ...
            <form action="?" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        placeholder="Ex.: Pedro de Alcântara Francisco Antônio João Carlos Xavier de Paula Miguel Rafael Joaquim José Gonzaga Pascoal Cipriano Serafim de Bragança e Bourbon" 
                    ...
                    <!-- ALERTA SOBRE AS SENHAS -->
                    <div class="alert alert-danger" role="alert" 
                    id="alertaSenhas" style="display:none">
                ...
                if ($formEdicao) {
                ?>
                    <input class="btn btn-outline-primary mt-3" type="submit" name="btnEditar" id="btnEditar" value="Editar Usuário">
                <?php
                } else {
                ?>
